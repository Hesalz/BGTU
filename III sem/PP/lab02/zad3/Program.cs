...
public class Organization : IStaff
{
    ...
    public List<JobTitle> getJobTitles() { return new List<JobTitle>(); }
    public int addJobTitle(JobTitle jobTitle) { return 0; }
    public string printJobVacancies() { return ""; }
    ...
    public bool dismiss(int id, string reason) { return false; }
...
public class Program
{
    static void Main(string[] args)
    {
        ...
        myUniversity.addFaculty(scienceFaculty); myUniversity.addFaculty(scienceFaculty); Console.WriteLine($"{myUniversity},\n{scienceFaculty}");
